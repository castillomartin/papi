...
cd $TEST_PATH
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/pthread_default
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/pthread_user_nodefault
rm -r $PAPI_OUTPUT_DIRECTORY
./pthread
generate_json_output
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/pthread_user_default
rm -r $PAPI_OUTPUT_DIRECTORY
./pthread
generate_json_output