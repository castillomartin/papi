...
cd $TEST_PATH
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/omp_default
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/omp_user_nodefault
rm -r $PAPI_OUTPUT_DIRECTORY
./omp
generate_json_output
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/omp_user_default
rm -r $PAPI_OUTPUT_DIRECTORY
./omp
generate_json_output