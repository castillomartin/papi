...
cd $TEST_PATH
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/mpi_omp_default
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/mpi_omp_user_nodefault
rm -r $PAPI_OUTPUT_DIRECTORY
mpirun -n 2 ./mpi_omp
generate_json_output
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/mpi_omp_user_default
rm -r $PAPI_OUTPUT_DIRECTORY
mpirun -n 2 ./mpi_omp
generate_json_output