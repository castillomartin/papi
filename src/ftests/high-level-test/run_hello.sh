...
cd $TEST_PATH
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/hello_default
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/hello_user_nodefault
rm -r $PAPI_OUTPUT_DIRECTORY
./hello
generate_json_output
...
export PAPI_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/hello_user_default
rm -r $PAPI_OUTPUT_DIRECTORY
./hello
generate_json_output